      ...
      <div className="p-6">
        ...
        <div className="flex gap-3 pt-4 border-t border-slate-700/50 md:hidden">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-700/50 text-white text-sm font-semibold rounded-lg border border-slate-600 hover:border-cyan-400 transition-all duration-200"
          >
