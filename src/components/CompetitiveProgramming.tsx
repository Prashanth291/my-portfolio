...
const CompetitiveProgramming = () => {
  return (
    <section id="profiles" className="relative py-20 lg:py-28 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 overflow-hidden"> 
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-16 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
            Competitive <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Programming</span>
          </h2>
