...
const Skills = () => {
  return (
  <section id="skills" className="relative py-20 lg:py-28 bg-white dark:bg-gradient-to-b dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 overflow-hidden transition-colors duration-300">
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-16 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-4">
            My Tech <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent dark:text-transparent text-slate-900">Stack</span>
          </h2>
        ...
        >
          {skills.map((skill) => (
            <motion.div
              key={skill.name}
              className="group relative aspect-square flex flex-col items-center justify-center p-4 bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-200 dark:border-slate-700/50 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden"
            ...
            >
              ...
              {/* Skill Name */}
              <p className="relative z-10 text-sm md:text-base font-semibold text-slate-900 dark:text-slate-100 group-hover:text-slate-900 dark:group-hover:text-white transition-colors duration-300 text-center">
                {skill.name}
              </p>
